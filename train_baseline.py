...
from Baselines.Baselines import Baseline_random,Baseline_prior_yes,Baseline_Q_type_prior,Baseline_KNN
...
if __name__ == "__main__":
    baseline_model_list = ["random","prior yes","prior_q_type"]
    #main("prior_yes")
    main("KNN")